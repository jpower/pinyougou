                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                        ...
                        <dl>
                            ...
                            <dd><a href="javascript:;" ng-click="selectSpecification('${spec.attributeName}','${item}')" class="{{isSelected('${spec.attributeName}','${item}')?'selected':''}}" >${item}<span title="点击取消选择">&nbsp;</span>
                            </a></dd>
                            </#list>
