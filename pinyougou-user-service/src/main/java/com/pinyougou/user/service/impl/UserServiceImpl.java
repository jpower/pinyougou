...
public class UserServiceImpl implements UserService {
    ...
    @Value("${redis_sms_code_name}")
    private String redis_sms_code_name;
    ...
    public void sendCode(String phone) {
        ...
        redisTemplate.boundHashOps(redis_sms_code_name).put(phone, code+"");
        jmsTemplate.send(queueSMSDestination, new MessageCreator() {
            ...
            public Message createMessage(Session session) throws JMSException {
                ...
                mapMessage.setString("params", code + ",2");
                return mapMessage;
            }
        });
    ...
    @Override
    public boolean compareCode(String phone,String smscode) {
        String code = (String) redisTemplate.boundHashOps(redis_sms_code_name).get(phone);
