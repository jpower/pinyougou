...
public class SeckillGoodsServiceImpl implements SeckillGoodsService {
     ...
     */
    @Override
    public List<TbSeckillGoods> findValidAllFromRedis() {
        ...
        if (seckillGoods == null || seckillGoods.size() == 0) {
            ...
            seckillGoods = seckillGoodsMapper.selectByExample(seckillGoodsExample);
            ...
            System.out.println("从缓存中查询秒杀商品");
        }
        return seckillGoods;
    }

    /**
     * 根据秒杀商品ID从redis中取出秒杀商品
     * @param id
     * @return
     */
    @Override
